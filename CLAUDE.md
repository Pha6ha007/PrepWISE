...
- [x] .claude/agents/ с агентами разработки ✅
- [x] Supabase проект настроен ✅
- [x] Prisma schema + первая миграция ✅
...
- [x] Онбординг с дисклеймером ✅
- [x] Базовые страницы: landing, login, dashboard ✅

Неделя 3-4: AI ядро ✅
- [x] Интеграция OpenAI API (GPT-4o) ✅
- [x] RAG: PDF → чанкинг → embeddings → Pinecone ✅
- [x] Первый агент (anxiety) с системным промптом ✅
- [x] Retrieval при каждом запросе ✅

Неделя 5: Память ✅
- [x] Session summary после каждого разговора ✅
- [x] Memory Agent — обновление user_profile ✅
...
- [x] next-pwa интеграция ✅
- [x] Манифест приложения (installable) ✅
- [x] Service Worker для офлайн режима ✅
- [ ] Push уведомления (утренние check-ins) — требует production HTTPS

### Фаза 3 — Все агенты ✅ ЗАВЕРШЕНО (3/4 задач)
- [x] Все 6 специализированных агентов ✅
- [x] Orchestrator маршрутизация ✅
- [x] Переключение агентов с сохранением контекста ✅
- [ ] Бета-тест с реальными пользователями

### Фаза 4 — Аналитика ✅ ЗАВЕРШЕНО (11/11 задач)
...
- ТОЛЬКО текущее состояние проекта (~200 строк)
...
### docs/CRON.md
- Детальная документация Vercel Cron Jobs
- Security, тестирование, мониторинг, troubleshooting
- Best practices для новых cron jobs
- Обновлять при добавлении новых cron jobs

### docs/RAG_BOOK_UPLOAD_GUIDE.md
- Гайд по загрузке книг в Pinecone RAG
- Chunking, embeddings, namespaces

### docs/changelog/ (по дням)
- **Главный файл:** docs/changelog/README.md — таблица всех changelog файлов
...
- **ВАЖНО:** После добавления записи в дневной файл, обновь таблицу в docs/changelog/README.md
